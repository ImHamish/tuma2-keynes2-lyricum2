...
) ENGINE = MyISAM AUTO_INCREMENT = 121 CHARACTER SET = latin1 COLLATE = latin1_general_ci ROW_FORMAT = Fixed;
...
INSERT INTO `exp_table` VALUES (16, 130000);
...
INSERT INTO `exp_table` VALUES (59, 27960000);
...
INSERT INTO `exp_table` VALUES (100, 2100000000);
INSERT INTO `exp_table` VALUES (101, 2100000000);
INSERT INTO `exp_table` VALUES (102, 2100000000);
INSERT INTO `exp_table` VALUES (103, 2100000000);
INSERT INTO `exp_table` VALUES (104, 2100000000);
INSERT INTO `exp_table` VALUES (105, 2100000000);
INSERT INTO `exp_table` VALUES (106, 2100000000);
INSERT INTO `exp_table` VALUES (107, 2100000000);
INSERT INTO `exp_table` VALUES (108, 2100000000);
INSERT INTO `exp_table` VALUES (109, 2100000000);
INSERT INTO `exp_table` VALUES (110, 2100000000);
INSERT INTO `exp_table` VALUES (111, 2100000000);
INSERT INTO `exp_table` VALUES (112, 2100000000);
INSERT INTO `exp_table` VALUES (113, 2100000000);
INSERT INTO `exp_table` VALUES (114, 2100000000);
INSERT INTO `exp_table` VALUES (115, 2100000000);
INSERT INTO `exp_table` VALUES (116, 2100000000);
INSERT INTO `exp_table` VALUES (117, 2100000000);
INSERT INTO `exp_table` VALUES (118, 2100000000);
INSERT INTO `exp_table` VALUES (119, 2100000000);
INSERT INTO `exp_table` VALUES (120, 2100000000);
...
CREATE TABLE `gmhost`  (
  `mIP` varchar(16) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE `gmlist`  (
  ...
  `mAccount` varchar(16) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL DEFAULT '',
  `mName` varchar(16) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL DEFAULT '',
  `mContactIP` varchar(16) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE `locale`  (
  `mKey` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL DEFAULT '',
  `mValue` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE `priv_settings`  (
  `priv_type` enum('PLAYER','GUILD','EMPIRE') CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL DEFAULT 'EMPIRE' COMMENT 'GUILD and PLAYER are untested.',
...
CREATE TABLE `spam_db`  (
  ...
  `type` enum('SPAM','MAPS') CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL DEFAULT 'SPAM',
