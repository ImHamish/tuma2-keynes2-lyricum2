 ...
 * <phk@login.dkuug.dk> wrote this file.  As int32_t as you retain this notice you
...
void MD5Final(uint8_t digest[MD5_HASHBYTES], MD5_CTX* context);
void MD5Transform(uint32_t buf[4], uint32_t const in[16]);
char* MD5End(MD5_CTX*, char*);

char* lutil_md5_file(const char* filename, char* buf);
char* lutil_md5_data(const uint8_t* data, uint32_t len, char* buf);
