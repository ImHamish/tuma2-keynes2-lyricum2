...
extern const uint8_t fishEventPosition1[7][7];
extern const uint8_t fishEventPosition2[7][8];
#endif

#if defined(ENABLE_LETTERS_EVENT)
extern const uint32_t lettersReward[2];
#endif
...
extern const uint64_t s_aiAuraRefineInfo[AURA_GRADE_MAX_NUM][AURA_REFINE_INFO_MAX];
extern const uint64_t* GetAuraRefineInfo(uint8_t);
extern const uint64_t GetAuraRefineInfo(uint8_t, uint8_t);
#else
extern const uint32_t s_aiAuraRefineInfo[AURA_GRADE_MAX_NUM][AURA_REFINE_INFO_MAX];
extern const uint32_t* GetAuraRefineInfo(uint8_t);
extern const uint32_t GetAuraRefineInfo(uint8_t, uint8_t);
#endif
#endif
