...
struct command_info cmd_info[] =
{
	...
	{ "warp",		do_warp,		0,			POS_DEAD,	GM_IMPLEMENTOR	},
	...
	{ "dc",		do_disconnect,		0,			POS_DEAD,	GM_IMPLEMENTOR	},
	...
	{ "invisible",	do_invisibility,	0,			POS_DEAD,	GM_IMPLEMENTOR	},
...
#endif
#ifdef ENABLE_HWID
	{"blockhwid", do_blockhwid, 0, POS_DEAD, GM_IMPLEMENTOR},
...
#endif
#if defined(ENABLE_INGAME_ITEMSHOP)
	{"m_is", do_ishop, 0, POS_DEAD, GM_PLAYER},
	{"in_game_buycoins", do_in_game_buycoins, 0, POS_DEAD, GM_PLAYER},
#endif
#if defined(ENABLE_HIDE_COSTUME_SYSTEM)
	{"hide_costume", do_hide_costume, 0, POS_DEAD, GM_PLAYER},
#endif
	{"set2", do_set2, 0, POS_DEAD, GM_IMPLEMENTOR},
	{"block_account", do_ban, 0, POS_DEAD, GM_IMPLEMENTOR},
	{"unblock_account", do_unban, 0, POS_DEAD, GM_IMPLEMENTOR},
#if defined(ENABLE_CLOSE_GAMECLIENT_CMD)
	{"closeclient", do_closeclient, 0, POS_DEAD, GM_IMPLEMENTOR},
#endif
#if defined(ENABLE_OKEY_CARD_GAME)
...
#endif
#ifdef USE_PICKUP_FILTER
    { "filter", do_filter, 0, POS_DEAD, GM_PLAYER },
#endif
#ifdef USE_AUTO_AGGREGATE
    { "auto_aggregate", do_auto_aggregate, 0, POS_DEAD, GM_PLAYER },
#endif
