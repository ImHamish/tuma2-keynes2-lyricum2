...
enum EAffectTypes
{
	...
	AFFECT_PREMIUM_PLAYERS_01 = 549,
	AFFECT_PREMIUM_PLAYERS_02 = 550,
	AFFECT_PREMIUM_PLAYERS_03 = 551,
	AFFECT_PREMIUM_PLAYERS_04 = 552,
#endif
#ifdef ENABLE_DS_SET
	AFFECT_DS_SET = 563,
	AFFECT_DS_BNS1 = 564,
    ...
    AFFECT_PREMIUM_START            = 900,
    AFFECT_EXP_BONUS                = 900,
    AFFECT_ITEM_BONUS               = 901,
    AFFECT_SAFEBOX                  = 902,
    AFFECT_AUTOLOOT                 = 903,
    AFFECT_FISH_MIND                = 904,
    AFFECT_MARRIAGE_FAST            = 905,
    AFFECT_GOLD_BONUS               = 906,
//#ifdef ENABLE_VOTE4BONUS
    AFFECT_PREMIUM_BONUS1           = 907,
    AFFECT_PREMIUM_BONUS2           = 908,
    AFFECT_PREMIUM_BONUS3           = 909,
//#endif
//#ifdef USE_AUTO_HUNT
    AFFECT_AUTO_USE                 = 910,
//#endif
    AFFECT_PREMIUM_END              = 911,
//#ifdef USE_PICKUP_FILTER_ICO_AS_AFFECT
    AFFECT_PICKUP_FILTER            = 994,
//#endif
	AFFECT_FISH_BONUS = 995,
#ifdef ENABLE_AFFECT_ALIGNMENT
	AFFECT_EXPAND_ALIGNMENT = 996,
#endif
