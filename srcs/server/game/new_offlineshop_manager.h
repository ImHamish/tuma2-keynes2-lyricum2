...
/*db*/	void		SendShopLockBuyItemDBPacket(DWORD dwBuyerID, DWORD dwOwnerID,DWORD dwItemID, long long TotalPriceSeen);
...
/*db*/	bool		RecvShopExtendTimeClientPacket(LPCHARACTER ch, DWORD dwTime);
/*db*/	void		SendShopExtendTimeDBPacket(DWORD dwOwnerID, DWORD dwTime);
/*db*/	bool		RecvShopExtendTimeDBPacket(DWORD dwOwnerID, DWORD dwTime);
#endif
...
/*cli.*/bool		RecvShopBuyItemClientPacket(LPCHARACTER ch, DWORD dwOwnerID, DWORD dwItemID, bool isSearch, long long TotalPriceSeen);
#ifdef ENABLE_NEW_SHOP_IN_CITIES
...
/*cli.*/bool		RecvAuctionOpenRequestClientPacket(LPCHARACTER, uint32_t);
...
/*cli.*/void		SendAuctionListClientPacket(LPCHARACTER, const std::vector<TAuctionListElement>&);
