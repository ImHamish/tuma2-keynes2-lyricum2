...
#	define INTRUSIVE_HANDSHAKE_NEXT_PULSE 60 * 5 /* (seconds)
	...
	*/
#	define INTRUSIVE_HANDSHAKE_LIMIT 15 /* (handshakes)
...
class DESC
{
	...
	public:
		...
		bool			IsPhase(const uint8_t phase) const { return m_bPhase == phase; }
		...
		bool			DelayedDisconnect(int32_t);
		...
		void SetChannelStatusRequested();
