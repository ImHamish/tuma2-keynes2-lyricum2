...
bool CHARACTER::DragonSoul_RefineWindow_Open(LPENTITY pEntity)
{
	...
	{
		m_pointsInstant.playerSlots->m_pDragonSoulRefineWindowOpener = pEntity;
	}
...
bool CHARACTER::DragonSoul_RefineWindow_Close()
{
	if (m_pointsInstant.playerSlots)
	{
		m_pointsInstant.playerSlots->m_pDragonSoulRefineWindowOpener = nullptr;
	}
...
bool CHARACTER::DragonSoul_RefineWindow_CanRefine()
{
	...
	return m_pointsInstant.playerSlots->m_pDragonSoulRefineWindowOpener != nullptr;
}
