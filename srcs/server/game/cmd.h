...
extern void SendNoticeNew(BYTE type, BYTE empire, long mapidx, DWORD idx, const char * format, ...);
extern void BroadcastNoticeNew(BYTE type, BYTE empire, long mapidx, DWORD idx, const char * format, ...);
#endif
