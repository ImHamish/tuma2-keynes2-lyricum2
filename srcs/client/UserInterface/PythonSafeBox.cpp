...
#ifdef ATTR_LOCK
PyObject* safeboxGetItemAttrLocked(PyObject* poSelf, PyObject* poArgs)
{
	int iPos;
	if (!PyTuple_GetInteger(poArgs, 0, &iPos)) {
		return Py_BadArgument();
	...
	return Py_BuildValue("i", pInstance->lockedattr);
}
#endif
...
#ifdef ATTR_LOCK
		{"GetItemAttrLocked", safeboxGetItemAttrLocked, METH_VARARGS},
#endif
