 ...
 * \param DefValue    default std::string in the event of a failed read
 ...
 * - A std::string starting with 'y' or 'Y'
 * - A std::string starting with 't' or 'T'
 * - A std::string starting with '1'
 *
 * A false boolean is found if one of the following is matched:
 * - A std::string starting with 'n' or 'N'
 * - A std::string starting with 'f' or 'F'
 * - A std::string starting with '0'
 *
...
/** ini_puts()
 * \param Section     the name of the section to write the std::string in
