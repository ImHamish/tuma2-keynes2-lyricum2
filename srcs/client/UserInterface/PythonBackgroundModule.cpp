...
PyObject * backgroundSetEnvironmentData(PyObject * poSelf, PyObject * poArgs)
{
	...
	if (!CPythonSystem::instance().GetNightModeOption() 
		&& iIndex == CPythonBackground::DAY_MODE_DARK)
	{
...
{
	CPythonBackground& rkBG = CPythonBackground::Instance();
	return Py_BuildValue("i", rkBG.GetDayMode() == CPythonBackground::DAY_MODE_LIGHT ? 1 : 0);
}
...
PyObject* backgroundSetXMasShowEvent(PyObject* poSelf, PyObject* poArgs)
{
	...
	CPythonBackground::Instance().SetXMasShowEvent(iGrade);
	return Py_BuildNone();
}
#endif
