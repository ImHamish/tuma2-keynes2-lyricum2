...
uint8_t MULTI_LOCALE_NUM = DEFAULT_LANGUAGE;

uint8_t LocaleService_GetLocaleNum()
{
    return MULTI_LOCALE_NUM;
}

void LoadLocaleService_LocaleNum()
{
    if (strcmp(MULTI_LOCALE_NAME, "ro") == 0)
    {
        MULTI_LOCALE_NUM = LANGUAGE_RO;
    }
    else if (strcmp(MULTI_LOCALE_NAME, "it") == 0)
    {
        MULTI_LOCALE_NUM = LANGUAGE_IT;
    }
    else if (strcmp(MULTI_LOCALE_NAME, "tr") == 0)
    {
        MULTI_LOCALE_NUM = LANGUAGE_TR;
    }
    else if (strcmp(MULTI_LOCALE_NAME, "de") == 0)
    {
        MULTI_LOCALE_NUM = LANGUAGE_DE;
    }
    else if (strcmp(MULTI_LOCALE_NAME, "pl") == 0)
    {
        MULTI_LOCALE_NUM = LANGUAGE_PL;
    }
    else if (strcmp(MULTI_LOCALE_NAME, "pt") == 0)
    {
        MULTI_LOCALE_NUM = LANGUAGE_PT;
    }
    else if (strcmp(MULTI_LOCALE_NAME, "es") == 0)
    {
        MULTI_LOCALE_NUM = LANGUAGE_ES;
    }
    else if (strcmp(MULTI_LOCALE_NAME, "cz") == 0)
    {
        MULTI_LOCALE_NUM = LANGUAGE_CZ;
    }
    else if (strcmp(MULTI_LOCALE_NAME, "hu") == 0)
    {
        MULTI_LOCALE_NUM = LANGUAGE_HU;
    }
    else
    {
        MULTI_LOCALE_NUM = LANGUAGE_EN;
    }
}
#endif
