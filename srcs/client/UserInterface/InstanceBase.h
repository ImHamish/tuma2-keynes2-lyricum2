...
class CInstanceBase
{
	...
	public:
		...
		enum
		{
			...
			AFFECT_NEW_POTION32 = 601,
			AFFECT_NEW_POTION33 = 602,
			AFFECT_NEW_POTION34 = 603,
			AFFECT_NEW_POTION35 = 604,
			AFFECT_NEW_POTION36 = 588,
#if defined(USE_ANTI_EXP)
			AFFECT_ANTI_EXP = 605,
#endif
#endif

            NEW_AFFECT_EXP_BONUS            = 900,
            NEW_AFFECT_ITEM_BONUS           = 901,
            NEW_AFFECT_SAFEBOX              = 902,
            NEW_AFFECT_AUTOLOOT             = 903,
            NEW_AFFECT_FISH_MIND            = 904,
            NEW_AFFECT_MARRIAGE_FAST        = 905,
            NEW_AFFECT_GOLD_BONUS           = 906,
//#ifdef ENABLE_VOTE4BONUS
            NEW_AFFECT_PREMIUM_BONUS1       = 907,
            NEW_AFFECT_PREMIUM_BONUS2       = 908,
            NEW_AFFECT_PREMIUM_BONUS3       = 909,
//#endif
//#ifdef USE_AUTO_HUNT
            AFFECT_AUTO_USE                 = 910,
//#endif
//#ifdef USE_PICKUP_FILTER_ICO_AS_AFFECT
            AFFECT_PICKUP_FILTER            = 994,
//#endif
...
//#ifdef ENABLE_COSTUME_EFFECT
			...
			//ATLATNIS WEAPON EFFECT //
			EFFECT_WEAPON_ATLANTIS1 = 547,
			EFFECT_WEAPON_ATLANTIS2 = 548,
			EFFECT_WEAPON_ATLANTIS3 = 549,
			EFFECT_WEAPON_ATLANTIS4 = 550,
			EFFECT_WEAPON_ATLANTIS5 = 551,
			EFFECT_WEAPON_ATLANTIS6 = 552,
			EFFECT_WEAPON_ATLANTIS7 = 553,
			EFFECT_WEAPON_ATLANTIS8 = 554,
			EFFECT_COSTUME_ATLANTIS = 555,
			EFFECT_COSTUME_ATLANTIS2 = 556,
			EFFECT_WEAPON_ATLANTIS_DAGGER_LEFT = 557,
...
//#ifdef ENABLE_COSTUME_EFFECT
			...
			EFFECT_SCHOLAR_COSTUME_BODY,
			EFFECT_SCHOLAR_COSTUME_SWORD,
			EFFECT_SCHOLAR_COSTUME_TWOHAND,
			EFFECT_SCHOLAR_COSTUME_DAGGER,
			EFFECT_SCHOLAR_COSTUME_DAGGER_LEFT,
			EFFECT_SCHOLAR_COSTUME_BOW_LEFT,
			EFFECT_SCHOLAR_COSTUME_BELL,
			EFFECT_SCHOLAR_COSTUME_FAN,
			EFFECT_SCHOLAR_COSTUME_FAN_LEFT,
			EFFECT_SCHOLAR_COSTUME_RAPIER,

			EFFECT_DRAGON_COSTUME_BODY,
			EFFECT_DRAGON_COSTUME_SWORD,
			EFFECT_DRAGON_COSTUME_TWOHAND,
			EFFECT_DRAGON_COSTUME_DAGGER,
			EFFECT_DRAGON_COSTUME_DAGGER_LEFT,
			EFFECT_DRAGON_COSTUME_BOW_LEFT,
			EFFECT_DRAGON_COSTUME_BELL,
			EFFECT_DRAGON_COSTUME_FAN,
			EFFECT_DRAGON_COSTUME_FAN_LEFT,
			EFFECT_DRAGON_COSTUME_RAPIER,
			EFFECT_DRAGON_COSTUME_WING,
#if defined(ENABLE_HALLOWEEN_EVENT_2022)
			EFFECT_DARK_KNIGHT_COSTUME_BODY,
			EFFECT_DARK_KNIGHT_COSTUME_SWORD,
			EFFECT_DARK_KNIGHT_COSTUME_TWOHAND,
			EFFECT_DARK_KNIGHT_COSTUME_DAGGER,
			EFFECT_DARK_KNIGHT_COSTUME_DAGGER_LEFT,
			EFFECT_DARK_KNIGHT_COSTUME_BOW_LEFT,
			EFFECT_DARK_KNIGHT_COSTUME_BELL,
			EFFECT_DARK_KNIGHT_COSTUME_FAN,
			EFFECT_DARK_KNIGHT_COSTUME_FAN_LEFT,
			EFFECT_DARK_KNIGHT_COSTUME_RAPIER,

			EFFECT_DARK_VAMPIRE_COSTUME_BODY,
			EFFECT_DARK_VAMPIRE_COSTUME_SWORD,
			EFFECT_DARK_VAMPIRE_COSTUME_TWOHAND,
			EFFECT_DARK_VAMPIRE_COSTUME_DAGGER,
			EFFECT_DARK_VAMPIRE_COSTUME_DAGGER_LEFT,
			EFFECT_DARK_VAMPIRE_COSTUME_BOW_LEFT,
			EFFECT_DARK_VAMPIRE_COSTUME_BELL,
			EFFECT_DARK_VAMPIRE_COSTUME_FAN,
			EFFECT_DARK_VAMPIRE_COSTUME_FAN_LEFT,
			EFFECT_DARK_VAMPIRE_COSTUME_RAPIER,

			EFFECT_DRACULA_COSTUME_BODY,
			EFFECT_DRACULA_COSTUME_SWORD,
			EFFECT_DRACULA_COSTUME_TWOHAND,
			EFFECT_DRACULA_COSTUME_DAGGER,
			EFFECT_DRACULA_COSTUME_DAGGER_LEFT,
			EFFECT_DRACULA_COSTUME_BOW_LEFT,
			EFFECT_DRACULA_COSTUME_BELL,
			EFFECT_DRACULA_COSTUME_FAN,
			EFFECT_DRACULA_COSTUME_FAN_LEFT,
			EFFECT_DRACULA_COSTUME_RAPIER,
#endif

			EFFECT_BLUE_GHOST_COSTUME_BODY,
			EFFECT_BLUE_GHOST_COSTUME_SWORD,
			EFFECT_BLUE_GHOST_COSTUME_TWOHAND,
			EFFECT_BLUE_GHOST_COSTUME_DAGGER,
			EFFECT_BLUE_GHOST_COSTUME_DAGGER_LEFT,
			EFFECT_BLUE_GHOST_COSTUME_BOW_LEFT,
			EFFECT_BLUE_GHOST_COSTUME_BELL,
			EFFECT_BLUE_GHOST_COSTUME_FAN,
			EFFECT_BLUE_GHOST_COSTUME_FAN_LEFT,
			EFFECT_BLUE_GHOST_COSTUME_RAPIER,
...
//#endif
	...
	int GetPremiumPlayerTime();
	void SetPremiumPlayerTime(int iValue);
	...
	public:
		bool SetAura(uint32_t);
		void ChangeAura(uint32_t);
#endif
...
#endif
public:
	void SetCountryFlag(std::string country_flag) { m_country_flag = std::move(country_flag); }
