...
PyObject * chrCreateInstance(PyObject* poSelf, PyObject* poArgs)
{
	...
	if (PyTuple_Size(poArgs)==2)
	{
		...
		kCreateData.m_byPremium = 0;
		kCreateData.m_iPremiumTime = 0;
#endif
...
void initchr()
{
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_PREMIUM_BONUS1", CInstanceBase::NEW_AFFECT_PREMIUM_BONUS1);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_PREMIUM_BONUS2", CInstanceBase::NEW_AFFECT_PREMIUM_BONUS2);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_PREMIUM_BONUS3", CInstanceBase::NEW_AFFECT_PREMIUM_BONUS3);
#endif
	...
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION32", CInstanceBase::AFFECT_NEW_POTION32);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION33", CInstanceBase::AFFECT_NEW_POTION33);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION34", CInstanceBase::AFFECT_NEW_POTION34);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION35", CInstanceBase::AFFECT_NEW_POTION35);
	PyModule_AddIntConstant(poModule, "AFFECT_NEW_POTION36", CInstanceBase::AFFECT_NEW_POTION36);
    ...
    PyModule_AddIntConstant(poModule, "AFFECT_PICKUP_FILTER", CInstanceBase::AFFECT_PICKUP_FILTER);
#endif
}
