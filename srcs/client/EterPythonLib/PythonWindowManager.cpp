...
namespace UI
{
	...
	CWindowManager::CWindowManager()
		...
		m_iIgnoreEndTime(0),
		m_poMouseHandler(NULL), m_bAttachingFlag(FALSE), m_dwAttachingType(0),
		m_dwAttachingIndex(0),
		m_dwAttachingSlotNumber(0), m_byAttachingIconWidth(0), m_byAttachingIconHeight(0), m_pActiveWindow(NULL), m_pLockWindow(NULL), m_pPointWindow(NULL),
		m_pLeftCaptureWindow(NULL), m_pRightCaptureWindow(NULL), m_pMiddleCaptureWindow(NULL)
	{
