...
class CEffectManager : public CScreen, public CSingleton<CEffectManager>
{
	...
	public:
		int CreateEffectWithScale(DWORD dwID, const D3DXVECTOR3& c_rv3Position, const D3DXVECTOR3& c_rv3Rotation
#ifdef ENABLE_SKILL_COLOR_SYSTEM
, DWORD * dwSkillColor = NULL
#endif
		, float fParticleScale = 1.0f);
		void CreateEffectInstanceWithScale(DWORD dwInstanceIndex, DWORD dwID
#ifdef ENABLE_SKILL_COLOR_SYSTEM
, DWORD * dwSkillColor = NULL
#endif
