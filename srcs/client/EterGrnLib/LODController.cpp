...
void CGrannyLODController::SetMotionPointer(const std::shared_ptr<CGrannyMotion> c_pMotion, float fBlendTime, int32_t iLoopCount, float speedRatio)
#else
...
#if defined(ENABLE_GRANNY_INBUILD_ANIMATION)
void CGrannyLODController::ChangeMotionPointer(const std::shared_ptr<CGrannyMotion> c_pMotion, int32_t iLoopCount, float speedRatio)
#else
