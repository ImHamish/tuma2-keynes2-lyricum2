...
void CGrannyMesh::DeformPNTVertices(void * dstBaseVertices, D3DXMATRIX * boneMatrices, granny_mesh_binding* pgrnMeshBinding) const
{
	...
	// WORK
//	int32_t * boneIndices = (int32_t*)GrannyGetMeshBindingToBoneIndices(pgrnMeshBinding);
...
// WORK
//int32_t * CGrannyMesh::GetDefaultBoneIndices() const
const granny_int32x* CGrannyMesh::GetDefaultBoneIndices() const
{
//	return (int32_t*)GrannyGetMeshBindingToBoneIndices(m_pgrnMeshBindingTemp);
