...
{
	// deconstructor clear it already
	m_kMtrlPal.Clear();
...
//int32_t* CGrannyModelInstance::__GetMeshBoneIndices(uint32_t iMeshBinding) const
...
//	return (int32_t*)GrannyGetMeshBindingToBoneIndices(m_vct_pgrnMeshBinding[iMeshBinding]);
}
