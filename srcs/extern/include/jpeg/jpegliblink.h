#ifndef _LIB_JPEG_TURBO_LINK_H_
#define _LIB_JPEG_TURBO_LINK_H_
...
#pragma comment( lib, "libjpeg_a" _RUNTIME_LIBRARY ".lib")
#pragma comment( lib, "libjpeg-turbo" _RUNTIME_LIBRARY ".lib")

#endif /* !_LIB_JPEG_TURBO_LINK_H_ */
