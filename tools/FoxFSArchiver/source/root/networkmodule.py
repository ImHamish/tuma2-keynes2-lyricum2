...
class MainStream(object):
	...
	def SetPhaseWindow(self, newPhaseWindow):
		...
		if self.curPhaseWindow:
			if newPhaseWindow.__class__.__name__ in ("LoginWindow", "SelectEmpireWindow") or (self.curPhaseWindow.__class__.__name__ == 'GameWindow' and newPhaseWindow.__class__.__name__ == 'LoadingWindow') or (self.curPhaseWindow.__class__.__name__ == 'LoadingWindow' and newPhaseWindow.__class__.__name__ == 'GameWindow'):
				self.__ChangePhaseWindow()
			else:
