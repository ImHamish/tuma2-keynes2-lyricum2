				...
				},
				{
					...
					[
						...
						},
						{
							...
							"x":166,
							"y":107,
							"default_image":ROOT_PATH+"passive_expanded_button_01.sub",
							"over_image":ROOT_PATH+"passive_expanded_button_02.sub",
							"down_image":ROOT_PATH+"passive_expanded_button_03.sub",
						},
						{
							"name":"change_base_buttonImg",
							"type":"expanded_image",
							"image":"d:/ymir work/ui/old_level_img.tga",
							"x":8,
							"y":107,
						},
						{
							...
							"down_image":ROOT_PATH+"old_level_btn_01.sub",
						},
						{
									...
									[
										{
											...
											"x":19,
											"y":0,
											"image":ROOT_PATH+"char_info_status_value_img.sub",
										},
										{
							...
							[
								{ 
									...
									[
										...
										{"name":"Active_Skill_Point_Value","type":"text","x":25, "y":-2, "text":"99","r":1.0, "g":1.0, "b":1.0, "a":1.0, "text_horizontal_align":"center"},
									],
								},
								{
