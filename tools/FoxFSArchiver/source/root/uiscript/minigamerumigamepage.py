			...
			(
					...
					(
						{
							...
							"x" : 0,
							"y" : 0,
							"text" : uiscriptlocale.MINI_GAME_RUMI_TITLE,
							"all_align" : "center"
						},
					),
				},
				...
				},
				{
					...
					(
						...
						{
							"index" : 1,
							"x" : CARD_IMG_WIDTH * 1 + HAND_CARD_GAP * 1,
							"y" : 0,
							"width" : CARD_IMG_WIDTH,
							"height" : CARD_IMG_HEIGHT
						},
						{
							"index" : 2,
							"x" : CARD_IMG_WIDTH * 2 + HAND_CARD_GAP * 2,
							"y" : 0,
							"width" : CARD_IMG_WIDTH,
							"height" : CARD_IMG_HEIGHT
						},
						{
							"index" : 3,
							"x" : CARD_IMG_WIDTH * 3 + HAND_CARD_GAP * 3,
							"y" : 0,
							"width" : CARD_IMG_WIDTH,
							"height" : CARD_IMG_HEIGHT
						},
						{
							"index" : 4,
							"x" : CARD_IMG_WIDTH * 4 + HAND_CARD_GAP * 4,
							"y" : 0,
							"width" : CARD_IMG_WIDTH,
							"height" : CARD_IMG_HEIGHT
						},
				...
				},
				{
					...
					(
						...
						{
							"index" : 1,
							"x" : CARD_IMG_WIDTH * 1 + FIELD_CARD_GAP * 1,
							"y" : 0,
							"width" : CARD_IMG_WIDTH,
							"height" : CARD_IMG_HEIGHT
						},
						{
							"index" : 2,
							"x" : CARD_IMG_WIDTH * 2 + FIELD_CARD_GAP * 2,
							"y" : 0,
							"width" : CARD_IMG_WIDTH,
							"height" : CARD_IMG_HEIGHT
						},
