	...
	(
		{
			...
			"y" : 0,
			"width":304,
			"height":(SMALL_OPTION_HEIGHT * 2) - 30,
			"children":
			(
				{
					"name" : "pvp_mode",
...

		{
			...
			"type" : "window",
			"x" : 0,
			"y" : ((SMALL_OPTION_HEIGHT * 2) - 30)+NORMAL_OPTION_HEIGHT,
			"width":304,
		...
		},
		{
			...
			"type" : "window",
			"x" : 0,
			"y" : ((SMALL_OPTION_HEIGHT * 2) - 30)+NORMAL_OPTION_HEIGHT+SMALL_OPTION_HEIGHT,
			"width":304,
			"height":SMALL_OPTION_HEIGHT,
			"children":
			(
		...
		},
		{
			...
			"type" : "window",
			"x" : 0,
			"y" : ((SMALL_OPTION_HEIGHT * 2) - 30)+NORMAL_OPTION_HEIGHT+SMALL_OPTION_HEIGHT+SMALL_OPTION_HEIGHT,
			"width":304,
			"height":SMALL_OPTION_HEIGHT,
			"children":
			(
