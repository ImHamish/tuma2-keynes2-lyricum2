							...
							(
								{
									...
									"children" :
									( { "name" : "NormalInfoText2", "type" : "text", "x" : 0, "y" : -1, "all_align" : "center", "color" : 0xFFFFFFFF, "outline" : 1, "text" : uiscriptlocale.EXTENDED_BATTLE_PASS_INFO, }, ),
								},
								{
									"name" : "NormalTextInfo",
									...
									(
										{
											...
											"text" : "", "color" : 0xFFFFFFFF, "outline" : 1,
										},
										{
								...
								},
								{
									...
									(
										...
										},
										{
											...
											"text" : uiscriptlocale.EXTENDED_BATTLE_PASS_SEASON, "color" : 0xFFFFFFFF, "outline" : 1,
										},
										{
											"name" : "InputTicketInfoTimeText2", "type" : "text",
											"x" : 0, "y" : -46, "all_align" : "center",
											"text" : uiscriptlocale.EXTENDED_BATTLE_PASS_SEASON_DATE, "color" : 0xFFFFFFFF, "outline" : 1,
										},
										{
											"name" : "InputTicketInfoText", "type" : "text",
											"x" : 0, "y" : -15, "all_align" : "center",
											"text" : uiscriptlocale.EXTENDED_BATTLE_PASS_ACTIVATE, "color" : 0xFFFFFFFF, "outline" : 1,
										},
										## ItemSlot
										{
										...
										},
										{
											...
											"text_outline" : 1, "text_color" : 0xFFFFFFFF,  
											"text" : uiscriptlocale.EXTENDED_BATTLE_PASS_ACTIVATE_CONFIRM,
							...
							(
								{
									...
									"x" : 0, "y" : -2, "all_align" : "center",
									"text" : "%s", "color" : 0xFFFFFFFF, "outline" : 1,
								},
								{
									...
									(
										{
											...
											"text_color" : 0xffffffff, "outline" : 1,
										},
										{
