	...
	(
		{
			...
			"children" :
			(
				{ "name":"TitleBar", "type":"horizontalbar", "x": 7, "y": 30, "width": 187, "children" : ( { "name":"TitleBar_Block_Value", "type":"text", "x":8, "y":2, "text": localeinfo.DUEL_INFO_5, }, ), },
		...
		},
		{
			...
			"style" : ("attach",),
			"x" : 0, "y" : -15, "width" : 562, "height" : 280, "title" : "Duel with Go2Hell",
			"children" :
			(
				...
				{
					"name":"TitleBar2", "type":"horizontalbar", "x":ELEMENTS_POS_X+5, "y":40, "width":169,
					"children" :
					(
				...
				{ "name":"TitleBar3", "type":"horizontalbar", "x": 15, "y": 40, "width": 161, "children" : ( { "name":"TitleBar_Block_Value", "type":"text", "x":8, "y":2, "text": localeinfo.DUEL_TITLENAME_EQUIP, }, ), },
				{ "name":"TitleBar4", "type":"horizontalbar", "x": 377, "y": 40, "width": 169, "children" : ( { "name":"TitleBar_Block_Value", "type":"text", "x":8, "y":2, "text": localeinfo.DUEL_CHOOSE_BLOCK, }, ), },
