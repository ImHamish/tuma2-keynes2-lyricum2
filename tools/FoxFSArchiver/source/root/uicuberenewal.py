...
def FReturnInfo(func,index):
	if app.ENABLE_GAYA_RENEWAL and not app.ENABLE_CUBE_RENEWAL_COPY_WORLDARD:
	...
	elif not app.ENABLE_GAYA_RENEWAL and app.ENABLE_CUBE_RENEWAL_COPY_WORLDARD:
	...
	elif app.ENABLE_GAYA_RENEWAL and app.ENABLE_CUBE_RENEWAL_COPY_WORLDARD:
...
class CubeRenewalWindows(ui.ScriptWindow):
	...
	def __init__(self):
		...
		self.categoria = [
							...
							[
								52,
								"energy_craft",
								localeinfo.CUBE_CATEGORY52
							],
							[
								53,
								"auracraft1",
								localeinfo.CUBE_CATEGORY53
							],
							[
								54,
								"hallo1a",
								localeinfo.CUBE_CATEGORY54
							],
							[
								55,
								"hallo1b",
								localeinfo.CUBE_CATEGORY55
							],
							[
								56,
								"hallo1c",
								localeinfo.CUBE_CATEGORY56
							],
							[
								57,
								"hallo1d",
								localeinfo.CUBE_CATEGORY57
							],
							[
								58,
								"hallo1f",
							...
							[
								59,
								"beta_bracelet",
								localeinfo.CUBE_CATEGORY58
							],
							[
								60,
								"beta_necklace",
								localeinfo.CUBE_CATEGORY59
							],
							[
								61,
								"beta_earrings",
								localeinfo.CUBE_CATEGORY60
							],
							[
								62,
								"craft_roua",
								localeinfo.CUBE_CATEGORY63
							],
							[
								63,
								"zodiac_weapons",
								localeinfo.CUBE_CATEGORY61
							],
							[
								64,
								"zodiac_armors",
								localeinfo.CUBE_CATEGORY62
							],
							[
								65,
								"belts",
								localeinfo.CUBE_CATEGORY64
							],
							[
								66,
								"zodiac_antic",
								localeinfo.CUBE_CATEGORY65
							],
							[
								999,
								"WORLDARD",
	...
	def LoadWindow(self):
		...
		self.slot_improve.SetParent(self)
	...
	def UpdateMaterialCount(self):
		...
		if app.ENABLE_GAYA_RENEWAL:
			...
			self.gaya_text.Show()
			if player.GetGem() >= int(self.selectedItem.GetGaya()*count):
