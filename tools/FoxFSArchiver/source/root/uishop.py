...
class ShopDialog(ui.ScriptWindow):
	...
	if app.ENABLE_DYNAMIC_SHOP_SLOTSIZE:
	...
	def Open(self, vid):
		...
		if player.IsMainCharacterIndex(vid):
			...
			if app.ENABLE_DYNAMIC_SHOP_SLOTSIZE:
				...
				self.SetSize(184, 328 - EMPTY_SLOTS)
				self.board.SetSize(184, 328 - EMPTY_SLOTS)
				self.itemSlotWindow.ArrangeSlot(0, 5, 8 - EMPTY_SLOTS / 32, 32, 32, 0, 0)
				self.itemSlotWindow.RefreshSlot()
				self.itemSlotWindow.SetSlotBaseImage("d:/ymir work/ui/public/Slot_Base.sub", 1.0, 1.0, 1.0, 1.0)
				self.btnBuy.SetPosition(21, 295 - EMPTY_SLOTS)
				self.btnSell.SetPosition(104, 295 - EMPTY_SLOTS)
