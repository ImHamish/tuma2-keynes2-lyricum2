...
class DungeonInfo(ui.ScriptWindow):
	AFFECT_DICT = {
		...
		item.APPLY_ATTBONUS_MONSTER : localeinfo.TOOLTIP_APPLY_ATTBONUS_MONSTER2,
	}
	
	if app.ENABLE_RESIST_MONSTER:
		AFFECT_DICT[item.APPLY_RESIST_MONSTER] = localeinfo.TOOLTIP_APPLY_RESIST_MONSTER2

	if app.ENABLE_HALLOWEEN_EVENT_2022 and not app.USE_NO_HALLOWEEN_EVENT_2022_BONUSES:
		AFFECT_DICT[item.APPLY_FEAR] = localeinfo.TOOLTIP_DUNGEON_APPLY_FEAR
		AFFECT_DICT[item.APPLY_RESISTANCE_FEAR] = localeinfo.TOOLTIP_DUNGEON_APPLY_RESISTANCE_FEAR
	...
	def __del__(self):
		if self.dungeonItemToolTip:
			del self.dungeonItemToolTip
			self.dungeonItemToolTip = None
	...
	def LoadDialog(self):
		...
		try:
			...
			self.dungeonInfoShopTicket = self.GetChild("DungeonInfoShopTicket")
		...
		self.dungeonInfoShopTicket.SetEvent(self.ShopTicket)
	...
	def OnScroll(self):
		...
		for idx in xrange(min(self.MIN_SCROLLBAR_LIST, button_count)):
			...
			if realPos != self.dungeonIndex:
				self.dungeonButton[realPos].SetUpVisual("d:/ymir work/ui/game/dungeoninfo_2022/buttons/dungeonbutton1.png")
				self.dungeonButton[realPos].SetOverVisual("d:/ymir work/ui/game/dungeoninfo_2022/buttons/dungeonbutton1.png")
				self.dungeonButton[realPos].SetDownVisual("d:/ymir work/ui/game/dungeoninfo_2022/buttons/dungeonbutton3.png")
	...
	def AppendDungeonButton(self, index, parent, x, y):
		...
		self.dungeonButton[index].SetUpVisual("d:/ymir work/ui/game/dungeoninfo_2022/buttons/dungeonbutton3.png")
		self.dungeonButton[index].SetOverVisual("d:/ymir work/ui/game/dungeoninfo_2022/buttons/dungeonbutton3.png")
		self.dungeonButton[index].SetDownVisual("d:/ymir work/ui/game/dungeoninfo_2022/buttons/dungeonbutton3.png")
		...
		# self.dungeonImage[index].LoadImage("d:/ymir work/ui/game/dungeoninfo_2022/bosses/0.png")
		self.dungeonImage[index].SetPosition(0, 1)
		...
		self.dungeonImageIcon[index].SetUpVisual("d:/ymir work/ui/game/dungeoninfo_2022/bosses/%d.png" % dungeonMapIndex)
		self.dungeonImageIcon[index].SetOverVisual("d:/ymir work/ui/game/dungeoninfo_2022/bosses/%d.png" % dungeonMapIndex)
		self.dungeonImageIcon[index].SetDownVisual("d:/ymir work/ui/game/dungeoninfo_2022/bosses/%d.png" % dungeonMapIndex)
		...
		self.dungeonName[index].SetPosition(70, 18)
		...
		try:
			...
			if player.GetLevel() < dungeonMinLevel:
				try:
					...
					self.dungeonStatus[index].SetPosition(180, 18)
				except:
					pass
	...
	def LoadDungeonInfoBoard(self, index, retry = False):
		...
		try:
			self.dungeonButton[self.dungeonIndex].SetUpVisual("d:/ymir work/ui/game/dungeoninfo_2022/buttons/dungeonbutton3.png")
			self.dungeonButton[self.dungeonIndex].SetOverVisual("d:/ymir work/ui/game/dungeoninfo_2022/buttons/dungeonbutton3.png")
			self.dungeonButton[self.dungeonIndex].SetDownVisual("d:/ymir work/ui/game/dungeoninfo_2022/buttons/dungeonbutton3.png")
			...
			self.dungeonInfoBoard.LoadImage("d:/ymir work/ui/game/dungeoninfo_2022/backgrounds/%d.tga" % dungeonMapIndex)
	...
	def ShopTicket(self):
		import net
		net.SendChatPacket("/open_range_npc " + str(67))
	...
	def AnswerTeleport(self, answer):
		...
		if answer == True:
			...
			constinfo.dungeonData["quest_cmd"] = "WARP#%d#%d#%d" % (self.dungeonIndex, x, y)
