...
class DragonSoulWindow(ui.ScriptWindow):
	...
	def __InventoryLocalSlotPosToGlobalSlotPos(self, window_type, local_slot_pos):
		...
		if app.ENABLE_DS_GRADE_MYTH:
			return 300 + 25 + ((self.DSKindIndex * player.DRAGON_SOUL_PAGE_COUNT * player.DRAGON_SOUL_PAGE_SIZE) + self.inventoryPageIndex * player.DRAGON_SOUL_PAGE_SIZE + local_slot_pos)
		else:
			return 300 + 25 + ((self.DSKindIndex * 5 * player.DRAGON_SOUL_PAGE_SIZE) + self.inventoryPageIndex * player.DRAGON_SOUL_PAGE_SIZE + local_slot_pos)
