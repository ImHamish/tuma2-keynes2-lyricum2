...
if app.ENABLE_NEW_FISH_EVENT:
	events_default_data[player.JIGSAW_EVENT] = ["jigsaw_event", localeinfo.MINIGAME_FISH_EVENT]

if app.ENABLE_LETTERS_EVENT:
	events_default_data[player.LETTERS_EVENT] = ["letters_event", localeinfo.MINIGAME_LETTERS_EVENT]

if app.ENABLE_HALLOWEEN_EVENT_2022:
	events_default_data[player.HALLOWEEN_EVENT] = ["halloween_event", localeinfo.HALLOWEEN_EVENT]

if app.ENABLE_OKEY_CARD_GAME:
	events_default_data[player.OKEY_CARD_EVENT] = ["okaycards_event", localeinfo.MINIGAME_OKEY]
