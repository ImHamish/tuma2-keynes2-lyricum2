...
class BiologWindow(ui.ScriptWindow):
	...
	def Load(self):
		...
		try:
			...
			self.potionBox.SetPosition(CHECKBOX_X, 120)
			...
			self.potionPlusBox.SetPosition(CHECKBOX_X + 60, 120)
			...
			self.timeBox.SetPosition(85, 160)
	...
	def Open(self, args):
		...
		# self.listbox.SetHorizontalAlignCenter()
