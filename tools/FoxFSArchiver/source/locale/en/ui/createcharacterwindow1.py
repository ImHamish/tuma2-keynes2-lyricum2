...
window = {
	...
	(
		...
		## Big Name##
		{
			...
			"x" : BOARD_X + NAME_X, "y" : BOARD_Y - NAME_Y + 43, "x_scale" : NAME_SCALE_X, "y_scale" : NAME_SCALE_Y,
		...
		##Character Board(Left)##
		{
			...
			"x" : BOARD_X, "y" : BOARD_Y + 43, "width" : THINBOARD_CIRCLE_LEFT_WIDTH + (X_GAP * 2) + 1, "height" : 305 - 43,
			...
			(
				...
				
				{
					...
					"x" : X_GAP, "y" : 61, "width" : THINBOARD_CIRCLE_LEFT_WIDTH, "height" : 188,
					"children" :
					(
						##Job Select##
						{
		...
		## Change Country Flag ##
		{
			"name": "select_thinboard3", "type": "thinboard_gold",
			"x": BOARD_X,
			"y": BOARD_Y + 380 + 3,
			...
			"children":
				[
					{
						"name": "country_flag_prev_button", "type": "button", "x": 25, "y": 25,
					...
					},
					{
						...
						"name": "country_flag_next_button", "type": "button", "x": 25*2-5,
						"y": 25,
					...
					{
						"name": "countryName_Text", "type": "text", "x": 0, "y": 10, "r": 0.7843, "g": 0.7843,
						"b": 0.7843,
						"text": "Romania",
					...
					{
						"name": "country_flag", "type": "expanded_image",
						"x": 0, "y": 25,
						"horizontal_align": "center",
						# "x_scale": 1.4,
						# "y_scale": 1.4,
						"image": "d:/ymir work/ui/country_flags/ro.png"
					},
				],
		},
		...
		##Description Board(Right)##
		{
			...
			"x" : SCREEN_WIDTH - BOARD_X - (THINBOARD_CIRCLE_RIGHT_WIDTH + (X_GAP * 2)), "y" : BOARD_Y, "width" : THINBOARD_CIRCLE_RIGHT_WIDTH + (X_GAP * 2) + 1, "height" : THINBOARD_GOLD_HEIGHT + 28,
