...
window = {
	...
	(
			...
			(
				{
					...
					(
						...
						"locale/it/ui/Mall/coin_0010.sub",
        ...
        },
        {
			...
			"type" : "button",
			"x" : SCREEN_WIDTH - 167-10,
			"y" : -11+5+5+4,
			"tooltip_text" : uiscriptlocale.TASKBAR_MONEY_EXPAND,
			"default_image" :"icon/item/ex_gemshop_button_01.tga",
			"over_image" : "icon/item/ex_gemshop_button_02.tga",
			"down_image" : "icon/item/ex_gemshop_button_03.tga",
		},
