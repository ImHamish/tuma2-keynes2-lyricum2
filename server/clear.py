...
from os import getcwd as os_getcwd, chdir as os_chdir, listdir as os_listdir, remove as os_remove
...
def cleStart():
	...
	for dic1 in mList:
		...
		for f in os_listdir(dic1["path"]):
			n = f.lower()
			if n.count("valgrind-out"):
				os_remove(dic1["path"] + "/" + n)
