add_goto_info("zodyak1", 0, 221, 3072, 14080 )
add_goto_info("zodyak2", 0, 221, 3824, 14309 )
add_goto_info("zodyak3", 0, 221, 4331, 14322 )
add_goto_info("zodyak4", 0, 221, 3293, 14840 )
add_goto_info("zodyak5", 0, 221, 3808, 14827 )
add_goto_info("zodyak6", 0, 221, 4341, 14845 )
add_goto_info("zodyak7", 0, 221, 3331, 15345 )
add_goto_info("zodyak8", 0, 221, 3830, 15355 )
add_goto_info("zodyak9", 0, 221, 4349, 15362 )
...
add_goto_info("lava_fields", 0, 151, 25996, 22689)
...
add_goto_info("sands", 0, 74, 9325, 14480)
add_goto_info("snake", 0, 135, 316, 14148)

add_goto_info("easter1", 0, 156, 36083, 22703)
add_goto_info("easter2", 0, 157, 4037, 22766)

add_bgm_info(74, "desert_map01.mp3", 0.5);
add_bgm_info(151, "lava_fields.mp3", 0.5);
...
add_bgm_info(135, "end_of_day.mp3", 0.5);
add_bgm_info(136, "death_of_landmark.mp3", 0.5);
add_bgm_info(156, "enter_the_east.mp3", 0.5);
add_bgm_info(157, "enter_the_east.mp3", 0.5);
set_bgm_volume_enable();

---add_goto_info("209", 0, 209, 8537, 14164)		add_bgm_info(209, "enter_the_east.mp3", 0.5);		-- metin2_map_Mt_Th_dungeon_01
add_goto_info("210", 0, 210, 8167, 15050)		add_bgm_info(210, "enter_the_east.mp3", 0.5);		-- metin2_map_dawnmist_dungeon_01
add_goto_info("212", 0, 212, 3200, 15290)		add_bgm_info(212, "dungeon_fire.mp3", 0.5);			-- metin2_map_n_flame_dragon
